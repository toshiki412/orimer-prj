...
| 種別                      | UUID                                   | 用途      |
| ----------------------- | -------------------------------------- | ------- |
| Service                 | `12345678-1234-1234-1234-1234567890ab` | 制御用サービス |
| Characteristic (Notify) | `12345678-1234-1234-1234-1234567890ac` | 状態送信    |
| Characteristic (Write)  | `12345678-1234-1234-1234-1234567890ad` | 操作受信    |
